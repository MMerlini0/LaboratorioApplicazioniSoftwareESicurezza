                ...
                <table class="table table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th>Post ID</th>
                            <th>Articolo ID</th>
                            <th>Email commentatore</th>
                            <th>Contenuto</th>
                            <th>Orario commento</th>
                            <th>Data commento</th>
                            <th>Modifica</th>
                            <th>Cancella</th>
                        </tr>
                    ...
                    {?>
                        <tr>
                            <td><?php echo $row['commentiid']; ?></td>
                            <td><?php echo $row['postid']; ?></td>
                            <td><?php echo $row['articoloid']; ?></td>
                            <td><?php echo $row['utenteemail']; ?></td>
                            <td><?php echo $row['contenuto']; ?></td>
                            <td><?php echo $row['orariocommento']; ?></td>
                            <td><?php echo $row['datacommento']; ?></td>
                            <td><form style="margin-top: -15px;">
                                <a href="edit.php?commentiid=<?php echo $row['commentiid']; ?>" class="btn btn-success">Modifica dati</a>
                    </form></td>
                            <td> 
                                <form style="margin-top: -15px;" action="code.php" method="POST">
                                <input type="hidden" name=deletecommento value="<?php echo $row['commentiid']; ?>">
