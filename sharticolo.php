                ...
                <table class="table table-bordered">
                    ...
                    {?>
                        <tr>
                            ...
                            <td><?php echo $row['orariopubblicazione']; ?></td>
                            <td><?php echo $row['emailcreatore']; ?></td>
                            <td><form style="margin-top: -15px;">
                                <a href="edit.php?articoloid=<?php echo $row['articoloid']; ?>" class="btn btn-success">Modifica dati</a>
                    </form></td>
                    <td> 
                                <form style="margin-top: -15px;" action="code.php" method="POST">
                                <input type="hidden" name=deletearticoloid value="<?php echo $row['articoloid']; ?>">
